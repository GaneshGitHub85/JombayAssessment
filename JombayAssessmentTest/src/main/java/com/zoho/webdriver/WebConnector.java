...
public class WebConnector {
	...
	public void validatCreateCall(String expectedResult) {
		boolean result=isElementPresent("contactName_xpath");
		String actualResult="";
	...
	public void vaidateSubmit(String expectedResult) {
		boolean result=isElementPresent("SuccessfullySubmit_xpath");
		String actualResult="";
